...
func init() {
	registerCollector("netframework_clrinterop", NewNETFramework_NETCLRInteropCollector, nil)
}
...
func NewNETFramework_NETCLRInteropCollector(interface{}) (Collector, error) {
